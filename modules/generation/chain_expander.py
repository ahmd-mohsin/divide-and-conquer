...
class HierarchicalChainExecutor:
        ...
        for chain_idx in range(self.num_chains):
            try:
                ...
                if self.verbose:
                    ...
                    print(f"  Chain {chain_idx + 1}/{self.num_chains}: final_reward={reward_str}")
    ...
    def _create_step_prompt(
        ...
        prompt_parts.append("")
        prompt_parts.append("Solve this subproblem step by step. Provide your reasoning and final answer for THIS step.")
    ...
    def _generate_reasoning(self, prompt: str) -> str:
        ...
        system_prompt = """You are a mathematics expert solving problems step by step.
